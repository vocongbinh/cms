...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    IsNotified: Attribute.Boolean;
    favoritedApps: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    featuredImage: Attribute.Media<'images' | 'videos' | 'files' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    relatedTags: Attribute.Relation<
      'api::blog.blog',
      'oneToMany',
      'api::tag.tag'
    >;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    applications: Attribute.Relation<
      ...
      'api::application.application'
    >;
    featuredApp: Attribute.Relation<
      'api::category.category',
      'oneToMany',
      'api::application.application'
    >;
...
export interface ApiStatisticStatistic extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.Enumeration<['uaw', 'transaction', 'marketCap']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    changedValue: Attribute.Float &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    type: Attribute.Enumeration<['oneDay', 'oneWeek', 'oneMonth']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
